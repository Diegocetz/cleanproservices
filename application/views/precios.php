...
<br><br>
  ...
  <div class="card bg-footer">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
      <div class="card-body">
       Los servicios personalizados es para empresas que desea gestionar los servicios de limpieza de acorde a sus necesidades, por otro lado, el plan estandar solo cuenta con los servicios del plan. 
      </div>
    </div>
  </div>
  <div class="card bg-footer">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
      <div class="card-body">
       Tenemos cobertura en el sur de País (Campeche, Quintana Roo y Yucatán)
      </div>
    </div>
  </div>
</div>
