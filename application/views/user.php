  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="C:\xampp\htdocs\Testing.github.io\planNegocios.html" role="button" data-bs-toggle="dropdown">Plan de negocios</a>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">Convocatoria</a>
...
<body>
  ...
  <?php if(!empty($contenido_encabezado6)){
            foreach($contenido_encabezado6 as $item){
              echo '<h2 class="card-title">' . $item['nombre'] . '</h1>';
              echo '<p class="card-text">'. $item['contenido'] . '</p>';
            }
          }
          ?>
